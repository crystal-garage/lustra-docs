...
Lustra uses connection pooling to allow multiple transactions to run in parallel over multiple fibers.
...
begin
  ...
  spawn do
    # Lustra automatically create a connection nº1
  ...
  Lustra::SQL.execute("DROP TABLE tests;")
end
```
